    ...
    (() => {
            ...
            if (document.querySelector(".main-block__slider")) new core(".main-block__slider", {
                ...
                on: {
                    ...
                    slideChange: function(swiper) {
                        const crrentuSlide = document.querySelector(".fraction-controll__current");
                        crrentuSlide.innerHTML = swiper.realIndex + 1 < 10 ? `0${swiper.realIndex + 1}` : swiper.realIndex + 1;
                    }
                }
            });
        ...
        function documentActions(e) {
            ...
            if (targetElement.closest("[data-parent]")) {
                ...
                } else console.log("Ой ой, нема такого під меню :D");
                e.preventDefault();
            }
